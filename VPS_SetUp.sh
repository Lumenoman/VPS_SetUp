...
apt install -y curl wget git nano mc htop btop jq dnsutils net-tools ca-certificates gnupg lsb-release golang-go certbot chrony ufw fail2ban unattended-upgrades
